...
export const MerakIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" fill="none" role="img" aria-label="Merak logo symbol" {...props}>
...
export const MerakLogo = () => (
  <svg width="120" height="120" viewBox="0 0 128 128" role="img" aria-label="Merak logo">
    <g
      stroke="currentColor"
      strokeWidth="5"
...
export const GithubIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="GitHub repository" {...props}>
